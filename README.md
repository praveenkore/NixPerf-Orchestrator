...
- **Limitation of Liability**: Nixsoft Technologies Pvt. Ltd. is not liable for any damages arising out of the use or inability to use the software.
...
- **Enterprise Features**: This repository contains the open-source core engine. Advanced enterprise-grade features and professional support are available separately through Nixsoft Technologies Pvt. Ltd.
