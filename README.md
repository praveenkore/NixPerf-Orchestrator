...
- **As-Is Basis**: This software is provided "AS IS", WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.
- **Limitation of Liability**: Nixsoft Technologies Pvt. Ltd. (https://www.nixsoftech.in/) is not liable for any damages arising out of the use or inability to use the software.
- **Trademarks**: Use of the NixPerf-Orchestrator™ brand name and logos is governed by our [Trademark Policy](./TRADEMARKS.md). The Apache License does not grant rights to Nixsoft trademarks.
- **Enterprise Features**: This repository contains the open-source core engine. Advanced enterprise-grade features and professional support are available separately through Nixsoft Technologies Pvt. Ltd. (https://www.nixsoftech.in/)

For the full legal text, see the [LICENSE](./LICENSE) and [NOTICE](./NOTICE) files.
